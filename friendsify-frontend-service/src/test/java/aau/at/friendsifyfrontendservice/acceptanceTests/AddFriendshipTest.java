...
import java.net.URL;
public class AddFriendshipTest {
  ...
  public void addFriendship() {
    ...
    driver.findElement(By.id("friends_new")).click();
    {
      ...
      dropdown.findElement(By.xpath("//option[. = 'Maria Schmidt']")).click();
    }
    driver.findElement(By.cssSelector(".btn")).click();
    driver.findElement(By.cssSelector("td:nth-child(8) #table_entry_childs_button_7")).click();
